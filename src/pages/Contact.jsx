        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 text-font">
              Have questions about our asset management platform? We're here to
          ...
          <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
            ...
            <div className="lg:w-2/3 bg-gradient-to-b from-white/10 to-white/5 rounded-lg shadow-lg overflow-hidden">
              <div className="p-8 md:p-12">
                <h2 className="text-2xl font-bold text-gray-200 mb-6 title-font">
                  Send us a message
                </h2>

                {formStatus.submitted ? (
                  <div className="bg-green-50 border border-green-200 text-green-700 p-6 rounded-lg">
                    <h3 className="text-xl font-semibold mb-2 title-font">
            ...
            <div className="lg:w-1/3">
              <div className="bg-gradient-to-b from-white/10 to-white/5 p-8 rounded-lg shadow-md mb-8">
                <h3 className="text-xl font-semibold text-gray-200 mb-6 title-font">
                  Contact Information
                </h3>
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h4 className="text-md font-medium text-gray-200 title-font">
                        Phone
                      </h4>
              ...
              <div className="bg-gradient-to-b from-white/10 to-white/5 p-8 rounded-lg shadow-md">
                ...
                <ul className="space-y-3">
                  <li className="flex justify-between">
                    <span className="text-gray-500 text-font">
                      Monday - Friday
                    </span>
                    <span className="font-medium text-gray-200 title-font">
                      9:00 AM - 6:00 PM
                    </span>
                  </li>
                  <li className="flex justify-between">
