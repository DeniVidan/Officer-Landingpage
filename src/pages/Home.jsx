  ...
  return (
    <div className="min-h-screen bg-transparent w-[100vw] overflow-x-hidden">
      ...
      <section className="text-center py-20 md:pb-32 md:pt-32 w-auto mx-auto relative">
        ...
        <div
          className="hidden md:block absolute top-6 left-[15%] bg-transparent p-3 rounded-lg shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(255,255,255,0.06)] transform -rotate-3 animate-bounce"
        ...
        <div
          className="hidden md:block absolute top-16 right-[20%] bg-transparent p-3 rounded-lg shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(255,255,255,0.06)] transform rotate-2 animate-bounce"
        ...
        <div
          className="hidden md:block absolute bottom-20 left-[25%] bg-transparent p-3 rounded-lg shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(255,255,255,0.06)] transform rotate-6 animate-bounce"
        ...
        <div
          className="hidden md:block absolute bottom-12 right-[15%] bg-transparent p-3 rounded-lg shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(255,255,255,0.06)] transform -rotate-4 animate-bounce"
        ...
        <div
          className="md:hidden absolute top-[40px] right-3 bg-transparent p-3 rounded-lg shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(255,255,255,0.06)] flex items-center animate-pulse transform rotate-3"
        ...
        <div
          className="md:hidden absolute bottom-[15px] left-1 bg-transparent p-3 rounded-lg shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(255,255,255,0.06)] flex items-center animate-pulse transform -rotate-3"
        ...
        <h2 className="text-3xl md:text-7xl font-extrabold text-white title-font">
          Improve Your Asset
          <br />
          Management with <span className="text-[#007BCC] ">Officer</span>
        </h2>
        <p className="mt-4 text-gray-400 max-w-2xl mx-auto font-[CreatoDisplayRegular]">
          Simplify your business's asset management with our easy-to-use,
          scalable SaaS platform. Built for all around the world companies, our
          tools make complex processes simple.
        </p>
      ...
      <Faq
        ...
        subtitle="Everything you need to know about Officer's asset management platform"
