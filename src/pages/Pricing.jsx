          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="mt-8 inline-flex items-center justify-center bg-gray-800/50 p-2 rounded-full backdrop-blur-sm">
              <span
                className={`px-4 py-2 ${
                  !annual
                    ? "bg-[#007BCC] text-white rounded-full shadow-lg"
                    : "text-gray-300"
              ...
              <span
                className={`px-4 py-2 flex items-center ${
                  annual
                    ? "bg-[#007BCC] text-white rounded-full shadow-lg"
                    : "text-gray-300"
                } transition-all duration-300 cursor-pointer font-medium ml-2`}
                onClick={() => setAnnual(true)}
              >
                Annual{" "}
                <span
                  className={`px-2 py-1 rounded-full text-xs font-semibold ml-1 ${
                    annual ? "bg-white text-black" : "bg-[#66A3FE] text-white"
                  }`}
                >
                  20% off
                </span>
            ...
            {plans.map((plan) => (
              ...
              >
                  ...
                  <div className="mt-6 mb-8">
                    ...
                    {plan.duration && (
                      <div className="text-gray-300 mt-2">
                        {annual ? plan.duration.annual : plan.duration.monthly}
                      </div>
                    )}
                    {plan.saveText && annual && (
                      <div className="mt-3 inline-block bg-green-900/50 text-green-400 px-4 py-1 rounded-full font-medium border border-green-800/30">
                        {plan.saveText}
                      </div>
                    )}
                    {plan.trialText && (
                ...
                <div className="space-y-4 mb-8">
                  <p className="text-sm uppercase text-gray-400 font-semibold tracking-wider">
                    Features include:
                  </p>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-700">
                      {plan.features.slice(5).map((feature, i) => (
                        <div key={i} className="flex items-start mb-4">
                          ...
                          <span className="text-gray-300 text-font">
                            {feature}
                          </span>
                        </div>
                      ))}
                      ...
                      {plan.limitations && (
                        <>
                          <p className="text-sm uppercase text-gray-400 font-semibold tracking-wider mt-6 mb-4">
                            Limitations:
                          </p>
                          {plan.limitations.map((limitation, i) => (
                            <div key={i} className="flex items-start mb-4">
                              ...
                              <span className="text-gray-400 text-font">
                                {limitation}
                              </span>
                            </div>
                          ))}
                  ...
                  {featureCategories.map((category, idx) => (
                    <React.Fragment key={idx}>
                      <tr className="bg-gray-800/30">
                        <td
                          colSpan={5}
                          className="py-3 px-4 font-semibold text-gray-300"
                        >
                          {category.name}
                        </td>
                      </tr>
                      {category.features.map((feature, i) => (
                        <tr key={i} className="border-b border-gray-800/30">
                          ...
                          <td className="py-4 text-center">
                            {getCheckIcon(feature.business)}
                          </td>
                          <td className="py-4 text-center">
                            {getCheckIcon(feature.enterprise)}
                          </td>
                        </tr>
                      ))}
                    </React.Fragment>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-2/3 mb-8 md:mb-0 md:pr-10">
                ...
                <p className="text-gray-300 mb-6">
                  Our enterprise plan is tailored to meet the unique needs of
                  large organizations. Get a custom quote based on your specific
                  requirements.
                </p>
                ...
                <button href="/contact" className="px-8 py-3 bg-white text-blue-800 hover:bg-gray-100 font-bold rounded-xl shadow-lg transition-all duration-300">
                  Contact Sales Team
                </button>
              </div>
